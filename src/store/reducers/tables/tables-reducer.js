...
const reducer = (state = initialState, action) => {
    switch (action.type) {
        // all tables actions
        case actionTypes.LOAD_TABLES_START: return loadTablessStart(state, action);
        case actionTypes.LOAD_TABLES_SUCCESS: return loadTablessSuccess(state, action);
        case actionTypes.LOAD_TABLES_FAIL: return loadTablessFail(state, action);
